...
public class SoulExplosionRenderer extends EntityRenderer<dev.gabereal.entity.SoulExplosionEntity> {
    ...
    @Override
    public void render(dev.gabereal.entity.SoulExplosionEntity entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
    ...
    @Override
    public Identifier getTexture(dev.gabereal.entity.SoulExplosionEntity entity) {
        return null;
    }
}